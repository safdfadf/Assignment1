...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class FXAA : IAntiAliasing
    {
        ...
        public struct Preset
        {
            ...
            public static Preset extremePerformancePreset { get; } = new()
            {
            ...
            public static Preset performancePreset { get; } = new()
            {
                qualitySettings = new QualitySettings
                {
            ...
            public static Preset defaultPreset { get; } = new()
            {
                qualitySettings = new QualitySettings
                {
            ...
            public static Preset qualityPreset { get; } = new()
            {
                qualitySettings = new QualitySettings
                {
            ...
            public static Preset extremeQualityPreset { get; } = new()
            {
                qualitySettings = new QualitySettings
                {
                    subpixelAliasingRemovalAmount = 1.0f,
